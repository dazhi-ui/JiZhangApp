...
public class WeixinFragment12 extends AppCompatActivity implements View.OnClickListener, DatePicker.OnDateChangedListener, TimePicker.OnTimeChangedListener {
    ...
    private RadioButton strbut1,strbut2,strbut3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tap12);
        context=this;
        intent=getIntent();
        username=intent.getStringExtra("username");//经检验已经成功
        Toast.makeText(WeixinFragment12.this,"欢迎用户"+username+"增加收入账单",Toast.LENGTH_SHORT).show();

        queding=(Button)findViewById(R.id.wenbut22);
        back=(Button)findViewById(R.id.wenbut12);
        jine1=(EditText) findViewById(R.id.jine2);
        neirong1=(EditText)findViewById(R.id.neirong2);

        dbOpenMessage=new DBOpenMessage(WeixinFragment12.this,"db_wen2",null,1);

        group=(RadioGroup)findViewById(R.id.kind2);
        strbut1=(RadioButton)findViewById(R.id.radBtnAgeRange12);
        strbut2=(RadioButton)findViewById(R.id.radBtnAgeRange22);
        strbut3=(RadioButton)findViewById(R.id.radBtnAgeRange32);


        llDate = (LinearLayout) findViewById(R.id.ll_date2);
        tvDate = (TextView) findViewById(R.id.tv_date2);

        llTime = (LinearLayout) findViewById(R.id.ll_time2);
        tvTime = (TextView) findViewById(R.id.tv_time2);

        back=(Button)findViewById(R.id.wenbut12);
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(WeixinFragment12.this,AllWord.class);
        ...
        queding.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                switch (group.getCheckedRadioButtonId()) {
                    case R.id.radBtnAgeRange12:
                        userkind = "工资";
                        break;
                    case R.id.radBtnAgeRange22:
                        userkind = "奖金";
                        break;
                    case R.id.radBtnAgeRange32:
                        userkind = "其他";
                        break;
                    default:break;
                }
                ...
                {
                    Toast.makeText(WeixinFragment12.this,"存在没有填写的项目,请重新输入",Toast.LENGTH_SHORT).show();
                }
                else
                {
                    ...
                    wen="wen";
                    Toast.makeText(WeixinFragment12.this,"添加成功请继续操作",Toast.LENGTH_SHORT).show();
                }
            }
        });
